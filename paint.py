...
from feed_image import classify_img
...
class ImageGenerator:
	def __init__(self,parent,posx,posy,*kwargs):
		...
		# self.testbox = tk.Label(self, text="hi")
		self.textbox = tk.Text(root, height=2, width=30)
	...
	# save image user sketched and classify it
	def save(self):
		cwd = os.getcwd()
		...
		filename = "temp.png"
		img_path = os.path.join(user_img_dir, filename)
		self.image.save(img_path)

		# classify image
		label_index, label = classify_img(img_path)
		# res = "u drew a " + label
		# label.set(res)
